...
echo "    打开：$SCRIPT_DIR/../references/01-project-knowledge-builder.md"
...
echo "    打开：$SCRIPT_DIR/../references/02-interview-generator.md"
...
echo "    打开：$SCRIPT_DIR/../references/03-story-card-builder.md"
